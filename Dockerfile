...
# VSCode server
# ------------------------------------------------------------------
    wget -q https://github.com/cdr/code-server/releases/download/v4.95.2/code-server_4.95.2_amd64.deb && \
    dpkg -i code-server_4.95.2_amd64.deb && \
    rm code-server_4.95.2_amd64.deb
# ==================================================================
# OOM guard
